...
export class HostNetwork {
    ...
    handleSignalingMessage(raw) {
        ...
        if (
            ...
            this.createInviteForPeer(
                message.peerId
            ).catch(error => {
                console.error(
                    "Failed to create peer offer:",
                    error
                );
        ...
        if (
            ...
            this.acceptAnswer(
                ...
                console.error(
                    "Failed to accept automatic answer:",
                    error
                );
    ...
    async createInviteForPeer(
        ...
        if (!connection) {
            throw new Error(
                "WebRTC connection disappeared while creating offer."
            );
        }
